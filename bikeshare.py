...
def get_filters():
    ...
    while True:
        ...
        if city in CITY_DATA.keys():
            ...
            print("Sorry, input city is invalid.")

    # TO DO: get user input for month (all, january, february, ... , june)
    months = ["jan", "feb", "mar", "apr", "may", "jun", "all"]
    while True:
        month = input("Enter the month (jan, feb, mar, apr, may, jun, all):\n").lower()
        if month in months:
            break
        else:
            print("Sorry, input month is invalid.")

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    days = ["saturday", "sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "all"]
    while True:
        day = input("Enter the month (monday, tuesday, . . . , sunday, all):\n").lower()
        if day in days:
            break
        else:
            print("Sorry, input day is invalid.")
...
def user_stats(df):
    ...
    # TO DO: Display counts of gender and showing no data for washington
    try:
        ...
        print('Sorry, no gender data available for wasington')
